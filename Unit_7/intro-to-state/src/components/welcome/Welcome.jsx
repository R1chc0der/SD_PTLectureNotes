...
export default function Welcome(props) {
  ...
  function removeName() {
    ...
    // Next we want to target our setName prop(function) and pass our new array as the updated value for our state variable. Aka we will reset the name array to the updatedNames filtered array.
